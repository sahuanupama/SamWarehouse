...
namespace SamWarehouse.Controllers
    ...
    public class WarrantyController : Controller
        ...
        public IActionResult Index()
            ...
            var files = filePaths.Select(file => new { Name = Path.GetFileName(file), Path = file });
            //Add the anonymous object list to the Viewbag to be passed to the view when opened.
